...
def main():
    ...
    for fake_type in fake_types:
        ...
        for compression_type in compression_types:
            experiment_stats[fake_type][compression_type] = {}
            for attack_method in attack_methods:
                
                for extension in ["", "_compressed"]:
                    experiment_stats[fake_type][compression_type]["{}{}".format(attack_method, extension)] = {}
                    ...
                    if os.path.isdir(adv_videos_dir) and os.path.isdir(detected_videos_dir):
                        ...
                        experiment_stats[fake_type][compression_type]["{}{}".format(attack_method, extension)] = copy.copy(attack_metrics)
