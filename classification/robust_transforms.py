...
"""
Adapting tensorflow code from
https://github.com/rshin/differentiable-jpeg  
"""
...
def rgb_to_ycbcr(input):
  ...
  output[:, 1, :, :] = input[:, 0, :, :] * 65.481 + input[:, 1, :, :] * 128.553 + input[:, 2, :, :] * 24.966 + 16
  output[:, 2, :, :] = input[:, 0, :, :] * 65.481 + input[:, 1, :, :] * 128.553 + input[:, 2, :, :] * 24.966 + 16
